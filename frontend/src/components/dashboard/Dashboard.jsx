...
//       const leadStats = statsResponse.data;
      
//       setStats({
//         totalCustomers: customersResponse.data.total || 0,
//         totalLeads: leadsResponse.data.total || 0,
//         leadStats: leadStats || { New: 0, Contacted: 0, Converted: 0, Lost: 0 }
//       });
...
//           <div className="stat-icon">✅</div>
//           <div className="stat-content">
//             <h3>{stats.leadStats.Converted || 0}</h3>
//             <p>Converted Leads</p>
//           </div>
//         </div>
